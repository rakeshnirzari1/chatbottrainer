            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 mb-8">
                <p className="text-gray-700 mb-0">
                  At ChatbotTrainer, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service.
                </p>
              </div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                To exercise these rights, please contact us at privacy@chatbottrainer.com.
              </p>
              ...
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                <p className="text-gray-700 mb-2">
                  <strong>Email:</strong> privacy@chatbottrainer.com
                </p>
                <p className="text-gray-700 mb-2">
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 mt-8">
                <p className="text-gray-700 mb-0">
                  By using ChatbotTrainer, you acknowledge that you have read and understood this Privacy Policy and agree to its terms.
                </p>
              </div>
            </div>
          </div>
