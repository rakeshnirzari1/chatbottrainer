            ...
            <div className="max-w-4xl mx-auto prose prose-lg">
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
                <p className="text-gray-700 mb-0">
                  Please read these Terms and Conditions carefully before using DashBot. By accessing or using our service, you agree to be bound by these terms.
                </p>
              </div>

              <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-8">1. Acceptance of Terms</h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                By accessing and using DashBot ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to these Terms and Conditions, please do not use the Service.
              </p>

              <h2 className="text-3xl font-bold text-gray-900 mb-4 mt-8">2. Description of Service</h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                DashBot provides an AI-powered chatbot creation and training platform that allows users to create custom chatbots based on their website content. The Service includes website crawling, content extraction, AI training, and chatbot deployment features.
              </p>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                The Service and its original content, features, and functionality are owned by DashBot and are protected by international copyright, trademark, and other intellectual property laws. You retain all rights to your content, and we claim no ownership over it.
              </p>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                To the maximum extent permitted by law, DashBot shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use the Service. Our total liability shall not exceed the amount you paid for the Service.
              </p>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                You agree to indemnify and hold harmless DashBot and its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses arising from your use of the Service or violation of these Terms.
              </p>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
                <p className="text-gray-700 mb-0">
                  By using DashBot, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.
                </p>
              </div>
            </div>
          </div>
